    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                <a href="index.php"><strong>TAMMEIR</strong></a>
			...
			<div class="nalika-profile">
				<div class="profile-dtl">
					...
					<h2><?php echo $firstname; ?> <span class="min-dtn"><?php echo $surname; ?> </span></h2>
				</div>
            ...
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    ...
                    <li >
                        ...
                        <li>
                            <a class="has-arrow" href="vote.php" aria-expanded="false">
                                <i class="icon nalika-new-file icon-wrap"></i> 
                                <span class="mini-click-non">Vote</span></a>
                            
                        </li>
                        <li >
                            <a class="has-arrow" href="results.php">
								   <i class="icon nalika-bar-chart icon-wrap"></i>
								   <span class="mini-click-non">Results</span>
								</a>
                                            ...
                                            <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                                ...
                                                <li class="nav-item">
                                                    <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
															...
															<span class="admin-name"><?php echo "$firstname $surname"; ?></span>
